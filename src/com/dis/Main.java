...
public class Main {
	...
	private static void readCsv(References references) throws SQLException, IOException, ParseException {
		...
		PreparedStatement statement = connection.prepareStatement(
				"INSERT INTO TRANSACTIONS (CITY_ID, SHOP_ID, ARTICLE_ID, COUNTRY_ID, PRODUCT_CATEGORY_ID, PRODUCT_FAMILY_ID, PRODUCT_GROUP_ID, DATE, SALES_COUNT, SALES_AMOUNT, REGION_ID) VALUES (?,?,?,?,?,?,?,?,?,?,?)");
	...
	/**
	 * Inserts all data from the DB2INST1 database into our own tables that were
	 * created by the {@link com.dis.data.DatabaseInitializer}
	 *
	 * @param references
	 */
